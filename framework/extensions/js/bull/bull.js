/*
    ...
    File name: bull.js (Version: 14.0)
...
function bull()
{
    ...
    function core()
    {
        ...
        function ajax_model()
        {
            ...
            this.http_session = function(url, data, mode)
            {
                ...
                if (mode === true)
                    __xml_http.onreadystatechange = self.state_changed;
        ...
        this.__data = function(url, data, element_id, content_fill_mode, success_callback, request_time_out, fail_callback)
        {
        ...
        this.__request = function(url, data, ajax_mode, success_callback, request_time_out, fail_callback)
        {
    ...
    this.data = function(url, data, element_id, content_fill_mode, success_callback, request_time_out, fail_callback)
    {
        ...
        return bull_core.__data(url, data, element_id, content_fill_mode, success_callback, request_time_out, fail_callback);
    ...
    this.request = function(url, data, ajax_mode, success_callback, request_time_out, fail_callback)
    {
        ...
        return bull_core.__request(url, data, ajax_mode, success_callback, request_time_out, fail_callback);
